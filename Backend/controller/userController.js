...
import createTokenAndSaveCookies from "../jwt/AuthTocken.js";
...
if(!email||!name||!password||!education||!phone||!role||!photo){
...
export const login = async(req,res)=> {
    ...
    try{
      if(!email || !password || !role){
        return res.status(400).json({message:"please enter the required filed"});
      }
